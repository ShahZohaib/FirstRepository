...
public class OrangeHRM_LoginPage extends DriverClass
{
	...
	static By after_login_check = By.xpath("//ul[@class=\"oxd-main-menu\"]");
...
///////////////////////////////////////////
		public static WebElement check_icons_Displayed()
		{
			return d.findElement(after_login_check);
		}
