...
public class Dashboard_Test extends BasePage_Driver
{
    ...
    public void bc()
    {
    	BasePage_Driver.er = report.createTest("DashboardPage");	
    }
    @BeforeMethod
	...
	public void Valid_dashboard_admin()
	{
		...
		BasePage_Driver.e.info("Valid_dashboard_Admin-Test 1 pass");
	}
	@Test(priority =2)
	public void Valid_dashboard_time()
	{
		DashboardPage_XPath.click_on_time();
		BasePage_Driver.e.info("Valid_dashboard_time-Test 2 pass");
	}
	@Test(priority =3)
	public void Valid_dashboard_leave()
	{
		DashboardPage_XPath.click_on_Leave();
		BasePage_Driver.e.info("Valid_dashboard_leave-Test 3 pass");
	}
}
